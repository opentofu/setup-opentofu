...
// Mock the module that exports fileSHA256
jest.unstable_mockModule('../util.js', () => ({
  fileSHA256: jest.fn().mockResolvedValue('mocked-hash'),
}));
  ...
  //    fs.promises.readFile.mockResolvedValue('mock file content');
    ...
    //  fileSHA256.mockResolvedValue(mockInvalidChecksum);
      ...
      await expect(setup()).rejects.toThrow(
        `Failed to download OpenTofu from mock-url: Invalid checksum mocked-hash`
      );
